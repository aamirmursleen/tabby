...
import { NewTabContextMenu, RefreshLocalTabContextMenu } from './tabContextMenu'
...
@NgModule({
    ...
    providers: [
        ...
        { provide: TabContextMenuItemProvider, useClass: RefreshLocalTabContextMenu, multi: true },
